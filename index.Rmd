...
The aim of this document is to present some recipes about importing and exporting vectors, and treatment and exploration of spatial data. I expect to add more recipes on vector styling and map composition. 

This is a brief introduction to QGIS, as such it does not intend to replace the [QGIS User Guide](https://docs.qgis.org/3.4/en/docs/user_manual/). I also recommend you visiting the [StackExchange](https://gis.stackexchange.com/) chanel, where you can get support on questions related to QGIS.
